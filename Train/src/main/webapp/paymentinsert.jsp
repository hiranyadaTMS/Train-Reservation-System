...
<head>
    ...
    <title>GoTrain - Payment Handler</title>
    <style>
        body {
...
<body>
    ...
    <div class="inquiry">
        <form action="pay" method="post">
            ...
            <center><input type="submit" id="insertbtn" name="insertbtn" value="SUBMIT" ></center>
        </form>

        <center><h3>Accepted Cards</h3></center>  
        <img class="cards" src="images/cards.png" alt="Accepted Cards">
    </div>
